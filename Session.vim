...
nnoremap \ut :UpdateTags:HighlightTags
nnoremap \t :!gnome-terminal
nnoremap \= =
nnoremap \p "*p
map \z z=1
...
map <F6> :!clear && perl6 %
map <F4> :!clear && ./%
map <F3> :noautocmd vimgrep /TODO/ **/*
map <F2> :!npm run build
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((15 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
